...
- Then in the next lecture we will lean how to deploy the containerized applications to the cloud.
...
## Previous Lecture:
- In the previous session, I explained the following steps #1 to Step #4.
- You can see them here at this link: https://github.com/MajidHaghparast/MSE/blob/main/lectures/Lecture%2013-2-2025.md
...
## This lecture:
- In this session, I will explain other steps.
