...
- In the previous lecture, we saw Steps 1 to Step 4.
- Now we want to see Steps 5 to Step 8

## Previous Lecture:
- In the previous session, I explained the following steps. You can see them here in this link: https://github.com/MajidHaghparast/MSE/blob/main/lectures/Lecture%2013-2-2025.md
